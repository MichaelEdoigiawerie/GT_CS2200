 ...
 */
void compute_stats() {
    stats.amat = ((double) (stats.accesses * MEMORY_ACCESS_TIME)
     + (double) (stats.page_faults * DISK_PAGE_READ_TIME)
     + (double) (stats.writebacks * DISK_PAGE_WRITE_TIME)) / stats.accesses;
}
